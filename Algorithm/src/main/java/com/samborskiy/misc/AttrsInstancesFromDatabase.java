 ...
 * @author Whiplash
 */
public class AttrsInstancesFromDatabase {

    private AttrsInstancesFromDatabase() {
    }
     ...
     * @return list of user {@link com.samborskiy.entity.instances.attrs.Account} get from database
     */
