...
public class ClassifierProperty {
    ...
    public static final String DEFAULT_FREQUENCY_ANALYZER = "com.samborskiy.entities.analyzers.frequency.FrequencyDictionary";
    public static final String DEFAULT_GRAMMAR_ANALYZER = "com.samborskiy.entities.analyzers.grammar.GrammarAnalyzer";
    public static final String DEFAULT_MORPHOLOGICAL_ANALYZER = "com.samborskiy.entities.analyzers.morphological.MorphologicalAnalyzer";
    public static final String DEFAULT_SENTENCE_ANALYZER = "com.samborskiy.entities.analyzers.sentence.TweetParser";
