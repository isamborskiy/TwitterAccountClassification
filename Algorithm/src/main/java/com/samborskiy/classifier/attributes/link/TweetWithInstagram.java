...
public class TweetWithInstagram extends LinkAttributeFunction {
    ...
    public TweetWithInstagram(FrequencyAnalyzer frequencyAnalyzer, GrammarAnalyzer grammarAnalyzer, MorphologicalAnalyzer morphologicalAnalyzer, TweetParser tweetParser) {
    ...
    protected Attribute getAttribute(double val, String... args) {
        return new Attribute(val, "tweets_with_instagram");
    }
}
